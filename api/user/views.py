...
from ..schemas import user_namespace,User_login,User_signup,User_signup_return
...
class UserSignin(Resource):
    ...
    def post(self):
        ...
        if User.query.filter(User.email==data.get("email")).first():
            ...
            new_user=User(phone_number=phone_number,first_name=first_name,last_name=last_name,email=email,)
            new_user.save()
            return new_user,200
